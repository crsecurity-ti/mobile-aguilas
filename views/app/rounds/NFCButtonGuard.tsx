  ...
  const validateNFCCode = async (nfcCode: any) => {
    ...
    if (
      !canContinueConsecutively({
        ...
        currentRoundData: roundsListData
          .filter((x: any) => x.uuid === roundListDataUuid)[0],
        qrLocation,
      })
    ) {
      Alert.alert("Requiere validar el código nfc anterior para continuar");
      return;
    }
